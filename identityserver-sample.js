...
var settings = {
    authority: 'https://proid.exepron.com/',
    client_id: '<PasteYourClientIdHere>',
    redirect_uri: 'http://127.0.0.1:5500/identityserver-sample.html',
    post_logout_redirect_uri: 'http://127.0.0.1:5500/identityserver-sample.html',
    response_type: 'id_token token',
    //response_mode:'fragment',
    scope: 'openid profile exepron.restapi',
    
    popup_redirect_uri:'http://127.0.0.1:5500/identityserver-sample-popup-signin.html',
    popup_post_logout_redirect_uri:'http://127.0.0.1:5500/identityserver-sample-popup-signout.html',
    
    silent_redirect_uri:'http://127.0.0.1:5500/identityserver-sample-silent.html',
...
function startSigninMainWindowDiffCallbackPage() {
    mgr.signinRedirect({state:'some data', redirect_uri: 'http://127.0.0.1:5500/identityserver-sample-callback.html'}).then(function() {
        log("signinRedirect done");
    }).catch(function(err) {
        log(err);
    });
